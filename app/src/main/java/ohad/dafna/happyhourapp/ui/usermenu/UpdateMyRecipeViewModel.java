...
public class UpdateMyRecipeViewModel extends AndroidViewModel {
    ...
    public UpdateMyRecipeViewModel(@NonNull @NotNull Application application) {
        super(application);
    ...
    public void updateMyRecipe(MyRecipeDatabase myRecipe) {
        manager.updateMyRecipe(myRecipe);
    }
